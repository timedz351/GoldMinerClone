...
mixer.init()
mixer.music.load("C:/Users/swisi/Desktop/Albumy/Yung Hurn - 1220/01. MHM.mp3")
mixer.music.play(-1)
def zvuk_cash():
      mixer.init()
      mixer.music.load("sounds/cash2.mp3")
      mixer.music.play()
def dalsi_level():
   global level
...
def end():
   global koniec,stop,button_koniec,level,uvod,totalscore
   totalscore+=skore
   koniec=1
   stop=1
   sleep(0.5)
...
def generuj_level(level):
   ...
   if level==2:
      ...
      ore_name=['zlato1','zlato2','zlato3','stone1','stone2','stone3','stone4','stone5','stone6']
