...
def end():
   global koniec,stop,button_koniec,level
   koniec=1
   stop=1
   canvas.delete('all')
   canvas.create_image(400,250,image=bg_end,tags='gmover')
   if goal > skore:
      button_koniec=tkinter.Button(text='TRY AGAIN',command=start,font=('8514oem',20,'bold'),highlightcolor='yellow')
...
def generuj_level(level):
   ...
   if level==1:
      ...
      goal=100
   if level==2:
      obrazky=['gold2','gold2','gold2','stone1','stone1','stone1']
      ore_name=['zlato1','zlato2','zlato3','stone1','stone2','stone3']
      suradnice=(90,380,400,390,710,380,140,350,400,350,660,350)
   vypocet_sur()
...
def tlacidla():
   ...
   button_koniec=tkinter.Button(text='TRY AGAIN',command=start,font=('8514oem',20,'bold'))
def start():
